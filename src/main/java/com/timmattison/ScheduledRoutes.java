...
public class ScheduledRoutes extends RouteBuilder {
    ...
    private void buildRefreshRoute(FlatpackDataFormat flatpackDataFormat, String route) {
        from(route)
                ...
                .split(body()).parallelProcessing().parallelAggregate().aggregationStrategyRef(NpaNxxListAggregator.class.getName()).beanRef(NpaNxxRecordProcessor.class.getName()).end()
